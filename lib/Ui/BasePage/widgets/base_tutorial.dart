...
TargetFocus buildNavTargetFocus(String identify, GlobalKey keyTarget,
  ...
  return TargetFocus(
    ...
    contents: [
      TargetContent(
        ...
        customPosition:
            CustomTargetContentPosition(top: SizeConfig.screenHeight * .62),
...
// TargetFocus buildAppbarTargetFocus(String identify, GlobalKey keyTarget,
//     String title, String subtitle, String svgAsset) {
//   return TargetFocus(
//     identify: identify,
//     keyTarget: keyTarget,
